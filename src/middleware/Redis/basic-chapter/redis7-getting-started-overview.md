...
![image-20230906140823671](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061408800.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403067.jpeg)

**与传统数据库关系**

- Redis是key-value数据库(NoSQL一种)，`MySQL`是关系型数据库。
- Redis数据操作主要在内存，而MySQL主要存储在`磁盘`。
- Redis在某一些场景使用中要明显优于MySQL，比如`计数器`、`排行榜`等方面。
...
![image-20230906141403064](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061414301.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403981.jpg)
 ...
 **英文官网：**  [Redis](https://redis.io/)

**中文官网：** [Redis网站](http://redis.cn/)
...
![redis历史版本回顾](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403007.jpg)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403122.png)

### 3.3 部分新特性总览：

2022年4月正式发布的Redis7.0是目前Redis历史版本中变化最大的版本。首先它有超过50个以上的新增命令，其次，它有大量核心特性的新增和改进。

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403152.png)

#### 1. Redis Functions

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403195.png)

#### 2. Client-eviction

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403247.png)

#### 3. Multi-part AOF

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403579.png)

#### 4. ACL v2 权限控制

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403684.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202309061403723.png)
