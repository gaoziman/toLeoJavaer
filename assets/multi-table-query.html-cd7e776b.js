...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>需要注意的是，如果我们使用了表的别名，在查询字段中、过滤条件中就只能使用别名进行代替，不能使用原有的表名，否则就会报错。</p></blockquote>`,37),u=e("p",null,[e("code",null,"阿里开发规范"),n("：")],-1),v=e("p",null,[n("【"),e("code",null,"强制"),n("】对于数据库中表记录的查询和变更，只要涉及多个表，都需要在列名前加表的别名（或 表名）进行限定。")],-1),o=e("p",null,[e("code",null,"说明"),n("：对多表进行查询记录、更新记录、删除记录时，如果对操作列没有限定表的别名（或表名），并且操作列在多个表中存在时，就会抛异常。")],-1),p=e("code",null,"正例",-1),g={href:"http://t1.name",target:"_blank",rel:"noopener noreferrer"},b={href:"http://t1.id=t2.id",target:"_blank",rel:"noopener noreferrer"},h=e("p",null,[e("code",null,"反例"),n("：在某业务中，由于多表关联查询语句没有加表的别名（或表名）的限制，正常运行两年后，最近在 某个表中增加一个同名字段，在预发布环境做数据库变更后，线上查询语句出现出 1052 异常：Column 'name' in field list is ambiguous。")],-1),y=d(`<p><strong>拓展4：连接多个表</strong></p><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/1554978354431.png" alt="1554978354431" tabindex="0" loading="lazy"><figcaption>1554978354431</figcaption></figure><p>**总结：连接 n个表,至少需要n-1个连接条件。**比如，连接三个表，至少需要两个连接条件。</p><p>练习：查询出公司员工的 last_name,department_name, city</p><h4 id="非等值连接" tabindex="-1"><a class="header-anchor" href="#非等值连接" aria-hidden="true">#</a> 非等值连接</h4><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/1554978442447.png" alt="1554978442447" tabindex="0" loading="lazy"><figcaption>1554978442447</figcaption></figure><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>SELECT e.last_name, e.salary, j.grade_level
