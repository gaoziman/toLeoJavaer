...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>ESCAPE</strong></p>`,65),m=e("ul",null,[e("li",null,[i("回避特殊符号的："),e("strong",null,"使用转义符"),i("。例如：将[%]转为["),e("span",{class:"katex"},[e("span",{class:"katex-mathml"},[e("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[e("semantics",null,[e("mrow"),e("annotation",{encoding:"application/x-tex"},"%]、[]转为[")])])]),e("span",{class:"katex-html","aria-hidden":"true"})]),i("]，然后再加上[ESCAPE‘$’]即可。")])],-1),v=s(`<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>SELECT job_id
FROM   jobs
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>SQL语句示例如下：</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>mysql&gt; SELECT &#39;shkstart&#39; REGEXP &#39;^s&#39;, &#39;shkstart&#39; REGEXP &#39;t$&#39;, &#39;shkstart&#39; REGEXP &#39;hk&#39;;
+------------------------+------------------------+-------------------------+
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>2. 查询以特定字符或字符串结尾的记录</strong><br> 字符‘$’匹配以特定字符或者字符串结尾的文本。</p><p>在fruits表中，查询f_name字段以字母‘y’结尾的记录，SQL语句如下：</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>mysql&gt; SELECT * FROM fruits WHERE f_name REGEXP &#39;y$&#39;;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,95),c=[r,m,v];function u(t,g){return l(),a("div",null,c)}const p=n(d,[["render",u],["__file","operator.html.vue"]]);export{p as default};
