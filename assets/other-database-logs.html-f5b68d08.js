...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-3-恢复的典型错误" tabindex="-1"><a class="header-anchor" href="#_7-3-恢复的典型错误" aria-hidden="true">#</a> 7.3 恢复的典型错误</h3><p>如果从服务器宕机，有的时候为了系统恢复，要重装操作系统，这样就可能会导致你的 <code>服务器名称</code> 与之前 <code>不同</code> 。而中继日志里是 <code>包含从服务器名</code> 的。在这种情况下，就可能导致你恢复从服务器的时候，无法 从宕机前的中继日志里读取数据，以为是日志文件损坏了，其实是名称不对了。</p><p>解决的方法也很简单，把从服务器的名称改回之前的名称。</p>`,193);function v(b,p){const n=a("ExternalLinkIcon");return l(),d("div",null,[m,t,e("p",null,[i("MySQL8.0 官网日志地址：“ "),e("a",u,[i("https://dev.mysql.com/doc/refman/8.0/en/server-logs.html"),r(n)]),i(" ”")]),g])}const _=s(c,[["render",v],["__file","other-database-logs.html.vue"]]);export{_ as default};
