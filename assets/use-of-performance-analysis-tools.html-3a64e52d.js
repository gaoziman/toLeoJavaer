...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220629172646367.png" alt="image-20220629172646367" tabindex="0" loading="lazy"><figcaption>image-20220629172646367</figcaption></figure></li><li><p>UNCACHEABLE SUBQUERY</p><p>不常用，就不多说了。</p></li><li><p>UNCACHEABLE UNION</p><p>不常用，就不多说了。</p></li></ul><h4 id="_4-partitions-可略" tabindex="-1"><a class="header-anchor" href="#_4-partitions-可略" aria-hidden="true">#</a> 4. partitions (可略)</h4>`,82),v=e("li",null,[i("代表分区表中的命中情况，非分区表，该项为"),e("code",null,"NULL"),i("。一般情况下我们的额查询语句的执行计划的"),e("code",null,"partitions"),i("列的值为"),e("code",null,"NULL"),i("。")],-1),p={href:"https://dev.mysql.com/doc/refman/5.7/en/alter-table-partition-operations.html",target:"_blank",rel:"noopener noreferrer"},b=e("li",null,"如果想详细了解，可以如下方式测试。创建分区表：",-1),y=a(`<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>-- 创建分区表，
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220704192020603.png" alt="image-20220704192020603" style="float:left;"><h2 id="_10-小结" tabindex="-1"><a class="header-anchor" href="#_10-小结" aria-hidden="true">#</a> 10. 小结</h2><p>查询是数据库中最频繁的操作，提高查询速度可以有效地提高MySQL数据库的性能。通过对查询语句的分析可以了解查询语句的执行情况，找出查询语句执行的瓶颈，从而优化查询语句。</p>`,139);function q(h,E){const s=d("ExternalLinkIcon");return c(),o("div",null,[r,e("p",null,[e("a",m,[i("https://dev.mysql.com/doc/refman/5.7/en/explain-output.html"),n(s)])]),e("p",null,[e("a",u,[i("https://dev.mysql.com/doc/refman/8.0/en/explain-output.html"),n(s)])]),g,e("ul",null,[v,e("li",null,[e("a",null,[e("a",p,[i("https://dev.mysql.com/doc/refman/5.7/en/alter-table-partition-operations.html"),n(s)])])]),b]),y])}const L=l(t,[["render",q],["__file","use-of-performance-analysis-tools.html.vue"]]);export{L as default};
